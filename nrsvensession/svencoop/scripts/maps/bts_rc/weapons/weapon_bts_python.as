...
void Register()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "CPython::weapon_bts_python", GetName() );
  g_CustomEntityFuncs.RegisterCustomEntity( "CPython::ammo_bts_python", GetAmmoName() );
