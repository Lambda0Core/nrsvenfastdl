...
const string V_MODEL = "models/bts_rc/weapons/v_crowbar.mdl";
...
class weapon_bts_crowbar : ScriptBasePlayerWeaponEntity, HLWeaponUtils
{
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bts_rc/weapons/v_crowbar.mdl" ), self.GetP_Model( "models/hlclassic/p_crowbar.mdl" ), CROWBAR_DRAW, "crowbar", 0, GetBodygroup() );
	}
	...
	bool Swing( int fFirst )
	{
		...
		if ( tr.flFraction >= 1.0 )
		{
			if( fFirst != 0 )
			{
				...
				{
				case 0:
					self.SendWeaponAnim( CROWBAR_ATTACK1MISS, 0, GetBodygroup() ); break;
				case 1:
					self.SendWeaponAnim( CROWBAR_ATTACK2MISS, 0, GetBodygroup() ); break;
				case 2:
		...
		else
		{
			...
			{
			case 0:
				self.SendWeaponAnim( CROWBAR_ATTACK1HIT, 0, GetBodygroup() ); break;
			case 1:
				self.SendWeaponAnim( CROWBAR_ATTACK2HIT, 0, GetBodygroup() ); break;
			case 2:
...
{
	g_CustomEntityFuncs.RegisterCustomEntity( "HL_CROWBAR::weapon_bts_crowbar", GetHLCrowbarName() );
	g_ItemRegistry.RegisterWeapon( GetHLCrowbarName(), "bts_rc/weapons" );
}
