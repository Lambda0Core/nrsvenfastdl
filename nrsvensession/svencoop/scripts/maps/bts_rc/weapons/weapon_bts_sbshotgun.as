...
const int BATTERY_DEFAULT_GIVE  = 5;
...
class weapon_bts_sbshotgun : ScriptBasePlayerWeaponEntity, HLWeaponUtils
{
	...
	void PrimaryAttack()
	{
		...
		m_pPlayer.FireBullets( 4, vecSrc, vecAiming, VECTOR_CONE_DM_SHOTGUN, 2048, BULLET_PLAYER_CUSTOMDAMAGE, 0, MAX_DMG );//m_pPlayer.FireBullets( 4, vecSrc, vecAiming, VECTOR_CONE_DM_SHOTGUN, 2048, BULLET_PLAYER_BUCKSHOT, 0 );
