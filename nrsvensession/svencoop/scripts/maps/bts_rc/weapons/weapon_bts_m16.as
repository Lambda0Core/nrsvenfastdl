...
const int M16A3_DEFAULT_GIVE 	= 30;
...
class weapon_bts_m16 : ScriptBasePlayerWeaponEntity, HLWeaponUtils
{
	...
	{
		Precache();
		g_EntityFuncs.SetModel( self, "models/w_m16.mdl" );
	...
	void Precache()
	{
		...
		g_Game.PrecacheModel( "models/w_m16.mdl" );
		g_Game.PrecacheModel( "models/p_m16.mdl" );
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( "models/bts_rc/weapons/v_m16a2.mdl" ), self.GetP_Model( "models/p_m16.mdl" ), M16A3_DRAW, "m16", 0, GetBodygroup() );
	}
...
void RegisterHLM16()
{
	g_CustomEntityFuncs.RegisterCustomEntity( "HL_M16A3::weapon_bts_m16", GetHLM16Name() );
	g_CustomEntityFuncs.RegisterCustomEntity( "HL_M16A3::ammo_bts_m16", GetHLM16AmmoName() );
	g_ItemRegistry.RegisterWeapon( GetHLM16Name(), "bts_rc/weapons", "556", "ARgrenades", GetHLM16AmmoName() );
}
