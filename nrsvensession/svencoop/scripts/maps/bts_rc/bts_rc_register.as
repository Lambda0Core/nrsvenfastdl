...
string ShuffleWaves = "GM_R_SLAVE_S1;GM_R_SLAVE_S2;GM_R_SLAVE_S3;GM_R_SLAVE_S4;GM_R_SLAVE_S5;GM_R_SLAVE_S6;GM_R_SLAVE_S7;GM_R_SLAVE_S8;GM_R_HOUND_S1;GM_R_HOUND_S2;GM_R_HOUND_S3;GM_R_HOUND_S4;GM_R_HOUND_S5;GM_R_HOUND_S6;GM_R_SNARK_S1;GM_R_SNARK_S2;GM_R_AGRUNT_S1;GM_R_AGRUNT_S2;GM_R_PITDRONE_S1;GM_R_PITDRONE_S2;GM_R_PITDRONE_S3;GM_R_CRAB_S1;GM_R_CRAB_S2;GM_R_CRAB_S3;GM_R_CRAB_S4;GM_R_CRAB_S5;RZ_1;RZ_2;RZ_3;RZ_4;RZ_5;RZ_6;RZ_7;RZ_8;RZ_9;RZ_10;RZ_11;RZ_12;RZ_13;RZ_14;RZ_15;RZ_16;RZ_17;RZ_18;RZ_19;RZ_20;RZ_21;RZ_22;RZ_23;RZ_24;RZ_25;RZ_26;RZ_27;RZ_28;RZ_29;RZ_30;RZ_31;RZ_32;RZ_33;RZ_34;RZ_35;RZ_36;RZ_37;RZ_38;RZ_39;RZ_40;RZ_41";
...
void ShuffleShitAround()
{
    ...
    //objTSP.Shuffle( ShuffleWaves, "", false, false );
	...
	g_Scheduler.SetTimeout( trigger_shuffle_position(), "Shuffle", delay * 2, ShuffleMonsters, "", false, false );
	g_Scheduler.SetTimeout( trigger_shuffle_position(), "Shuffle", delay * 4, ShuffleHeadcrabs, "", false, false );
	g_Scheduler.SetTimeout( trigger_shuffle_position(), "Shuffle", delay * 6, ShuffleBoss, "", false, false );
	g_Scheduler.SetTimeout( trigger_shuffle_position(), "Shuffle", delay * 8, ShuffleHull2, "", false, false );
	g_Scheduler.SetTimeout( trigger_shuffle_position(), "Shuffle", delay * 10, ShuffleWaves, "", false, false );
}
...
void MapInit()
{
	...
	RegisterRaptor(); // Custom weapons registered

	g_ClassicMode.ForceItemRemap( true );
	g_ClassicMode.SetItemMappings( @g_AmmoReplacement );

	// Hooks
    g_Hooks.RegisterHook( Hooks::Player::PlayerSpawn, @PLAYER_VOICES::bts_PlayerSpawn );
    g_Hooks.RegisterHook( Hooks::Player::PlayerKilled, @PLAYER_VOICES::bts_PlayerKilled );
    g_Hooks.RegisterHook( Hooks::Player::PlayerPostThink, @PLAYER_VOICES::bts_PlayerPostThink );

	// Sound Precache
	PLAYER_VOICES::bts_PrecachePlayerSounds();
}
