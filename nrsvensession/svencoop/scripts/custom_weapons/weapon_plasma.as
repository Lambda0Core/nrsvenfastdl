...
const string plasma_MODEL_VIEW		= "models/hlclassic/v_9mmhandgun.mdl";
...
const string plasma_SOUND_SHOOT		= "shl/weapons/plasma1.ogg";
const string plasma_SOUND_SHOOT2	= "shl/weapons/plasma2.ogg";
const string plasma_SOUND_RELOAD	= "shl/weapons/plasma_re.ogg";
int plasma_mode = 0;
...
class CWeaponplasma : ScriptBasePlayerWeaponEntity
{
	...
	bool Deploy()
	{
		return self.DefaultDeploy( self.GetV_Model( plasma_MODEL_VIEW ), self.GetP_Model( plasma_MODEL_PLAYER ), plasma_DRAW, "gauss" );
	}
	...
	void SecondaryAttack()
	{
		...
		self.SendWeaponAnim( plasma_SHOOT_EMPTY, 0, 0 );
	...
	void WeaponIdle()
	{
		...
		switch( g_PlayerFuncs.SharedRandomLong( basePlayer.random_seed, 0, 2 ) )
		{
			...
			case 1: self.SendWeaponAnim( plasma_IDLE2, 0, 0 ); break;
			case 2: self.SendWeaponAnim( plasma_IDLE2, 0, 0 ); break;
		}
